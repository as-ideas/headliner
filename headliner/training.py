...
if __name__ == '__main__':
    ...
    data_raw = read_data_json('headlinegen/resources/welt_dedup.json', 2000)
    train_data, val_data = train_test_split(data_raw, test_size=100, shuffle=True, random_state=42)
    summarizer = SummarizerAttention(lstm_size=256, embedding_size=50, max_head_len=20)
    trainer = Trainer(steps_per_epoch=1000, batch_size=16, steps_to_log=5)
